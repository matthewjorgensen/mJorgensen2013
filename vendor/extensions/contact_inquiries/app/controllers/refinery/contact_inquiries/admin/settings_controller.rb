    ...
    module Admin
      ...
      protected
        ...
        def save_subject_for_confirmation
          Refinery::ContactInquiries::Setting.confirmation_subject = params[:subject] if params.keys.include?('subject')
        end

        def save_message_for_confirmation
          Refinery::ContactInquiries::Setting.confirmation_message = params[:message] if params.keys.include?('message')
        end
